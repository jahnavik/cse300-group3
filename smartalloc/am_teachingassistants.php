...
<div id="left_content">
    <div id="h1" style=" font-weight:normal;  font-size:40px; ">  Teaching Assistants for this <b>Semester </b></div>
	
    
	<form action="upload_file.php" method="post" enctype="multipart/form-data" >
	<label for="file" style=" font-weight:normal;  font-size:20px; " class="text-info"><br/><br/><br/>Upload the list of Teaching Assistants here:</label>
	<input  type="file" name="file" id="file"   /> 
    
    <!--<input type ="submit"  name="submit" value="Upload" />-->
    </br>
     <button class="btn" type="submit"  id="hello" ><i class="cus-control-eject-blue"></i>   Upload</button>
