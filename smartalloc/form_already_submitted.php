...
<?php
echo"You have already submmited your Form!";
?>

  <?php
echo "</div>";
?>
<form action="ta_view_form.php" >
<input class="btn" style= "margin-left: 400px; top: -10em; position: relative;" type="submit" id="submit" value="View Filled Form">
 </form>
</div>
