...
<title>B.Tech Advanced Courses</title>
...
<form method="get" action="/search" id="search">
  ...
  <button type="button" class="close" data-dismiss="alert" title="This page contains the list of BTech advanced courses which are available in the current semester and you are free to apply for them.   "><i class="cus-information"></i></button>
  B.Tech Advanced Courses: 
</div>
