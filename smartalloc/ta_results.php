...
$query="SELECT * FROM ta_selection where email='$email'";
...
<div id="container">  
    <ul id="nav">  
        ...
        <li class="active"><a href="ta_results.php" >Results</a></li>  
...
<button type="button" class="close" ><i class="cus-error"></i></button>
<?php
echo"Your Result will be declared through mail.";
echo "</div>";
}
else {
...
$row=mysql_fetch_assoc($result);
			$no=$row['course_no'];
			//echo"$no";
$query1="SELECT * FROM course_list where c_no='$no'";
