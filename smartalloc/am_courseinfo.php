...
<div id="left_content">
  ...
  Course Information for this Semester:
	...
	<label for="file" style=" font-weight:normal;  font-weight:normal;  font: 17px/1.5em Verdana, Geneva, Arial, Helvetica, sans-serif; min-width: 1000px; "><br/>Upload the list of available courses here:</label>
    ...
    <!--<input type ="submit"  name="submit" value="Upload" />-->
     ...
     <button class="btn" type="submit" name="submit1" formaction="read_ta.php" id="move1" title="Go to the course list you just uploaded" ><i class="cus-user-go"></i>   Move to Form</button>
     </form>
...
<div id="right_content">
    ...
    <p style="margin-left:10px; line-height: 1; font: 12px/1.5em Verdana, Geneva, Arial, Helvetica, sans-serif; min-width: 90px;">  <br/>- Only xls file should be uploaded here for course information list. </p>
</div>
</div>
