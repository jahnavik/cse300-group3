...
<form method="get" action="/search" id="search">
  ...
  <button type="button" class="close"  title="This page contains the list of Teaching Assistants who have chosen your course as their third preference.  "><i class="cus-information"></i></button>
  Third Preferences:  
</div>
...
<td style="text-align: center;"><input type='checkbox' value='<?php echo $f3 ?>' name='<?php echo $f3 ?>' /></td>
