...
if($deadline[$j]==' ')
{  
$hr=(int)substr($deadline,$j+1,$j+2);
$min=(int)substr($deadline,$j+4,$j+5);
$sec=(int)substr($deadline,$j+7,$j+8);
break;
}
...
$email=$_POST["i3"];
$mail             = new PHPMailer();
$body             = "Dear Instructor,<br><br>This is to inform you that the list of courses for the current semester has been uploaded on the smarTAlloc website.<br>You are required to update your course page at http://14.139.56.179:8083/ by <b> $deadline </b><br><br><b>Note: This email is system generated. Do not reply to this mail.</b>";
$mail->Mailer = "smtp"; 
...
$mail->Subject    = "smarTAlloc : Update Course Information";
