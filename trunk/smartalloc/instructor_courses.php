...
<title>Courses Offered by you:</title>
...
<div style="float: right; position:relative; width: 25px; margin-right: 10px; top:-11.2em;z-index:1; text-decoration:none; border: 2px solid #fff;" >
 ...
 <div style = "float:left; position: relative; margin-left:-1180px; margin-top: 26px; line-height: 1; font: 24px/1.5em Verdana, Geneva, Arial, Helvetica, sans-serif; min-width: 130px; font-weight:normal; "><?php echo "$member_name"; ?>
  ...
  <div id="left_content1">
      ...
      <img style= " border: 2px solid  #eee; height: 300px; background-shadow: #000 2px 2px; " src="images/train-icon.png" />
  ...
  <p style="margin-left:200px;  font-weight:normal;  font: 20px/1.5em Verdana, Geneva, Arial, Helvetica, sans-serif; min-width: 90px; " class="text-info">Fill Course Details for:</p>
  <form name="form" action="instructor_mycourse.php" method="post" enctype="multipart/form-data">
  <?php
...
<input type="submit" class= "btn btn-info" style = "margin-left: 200px; float:left;" name="<?php echo $f1; ?>" title= "Click here to fill/look into the details of this course. " value="<?php echo $f2; ?>">
</br> </br>
<?php
$i++;
//echo $f1;
