...
<title>Home</title>
<link rel="stylesheet" href="css/style_ta_home.css" type="text/css" />
...
<div id="container">  
    <ul id="nav">  
        <li class="active"><a href="ta_home.php" title="Your dashboard">Home</a></li>  
        <li><a href="ta_courses.php" >Courses</a>
        <ul>
			<li><a href="ta_filling_deadline_check.php">Select Courses</a></li>
        ...
        <li><a href="ta_filling_deadline_check1.php" >Application</a></li>  
...
<div style="margin-right: 110px; margin-top: 45px; width: 450px; border: 2px solid #eee;">
		...
		<p style="line-height: 1; font: 12px/1.5em Verdana, Geneva, Arial, Helvetica, sans-serif; min-width: 130px;"></br></br>
			- The <b>Courses</b> tab has been given for you to select your preferred courses for teaching assistantship. </br>
            - The <b>Availaibility</b> tab has been given for you to track down how many other teaching assistants have applied for a course. </br>
            - The <b>Application</b> tab has been given for you to fill out the application form TAship. </br>
 		</p>	
	</div>
</div>
</div>
