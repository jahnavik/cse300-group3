...
<title>Courses Availaibility</title>
...
<div id="container">  
    <ul id="nav">  
        ...
        <li class="active"><a href="ta_courses_availaibility.php" >Availaibility</a></li>  
...
<div style="float: right; position:relative; width: 25px; margin-right: 10px; top:-11.2em;z-index:1; text-decoration:none; border: 2px solid #fff;" >
 ...
 <button type="button" class="close" title="This page contains a graphical view of how many TAs have applied for a particualr course. "><i class="cus-information"></i></button>
  Graph:
</div>
