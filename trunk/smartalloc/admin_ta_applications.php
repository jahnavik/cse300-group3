...
<title>Teaching Assistants Applications</title>
...
<div id="container">  
    <ul id="nav">  
        ...
        <li class="active"><a href="admin_ta_applications.php">TAship Applications</a></li>  
...
<form method="get" action="/search" id="search">
  ...
  <button type="button" class="close" data-dismiss="alert" title="This page contains the a list of all the application forms filled by teaching assistants. "><i class="cus-information"></i></button>
