...
<title>B.Tech Second Year Courses</title>
...
<li><a href="ta_view_application.php" >Application</a></li>  
...
<form method="get" action="/search" id="search">
  ...
  <button type="button" class="close" data-dismiss="alert" title="This page contains the list of Btech second year courses which are available in the current semester and you are free to apply for them.   "><i class="cus-information"></i></button>
  B.Tech Second Year Courses: 
</div>
