...
<div id="left_content">
    <div id="h1" style=" font-weight:normal;  font-size:40px; ">  Course Information for this <b>Semester </b></div>
	
    
	<form action="upload_file.php" method="post" enctype="multipart/form-data" >
	<label for="file" style=" font-weight:normal;  font-size:20px; "><br/><br/><br/>Upload the list of available courses here:</label>
