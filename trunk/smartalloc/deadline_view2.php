...
$email=$_POST["i3"];
$mail             = new PHPMailer();
$body             = "Dear Instructor,<br><br>This is to inform you that the list of TAs for the current semester has been uploaded on the smarTAlloc website.<br>You are required to select your TAs at http://14.139.56.179:8083/ by <b> $deadline </b><br><br><b>Note: This email is system generated. Do not reply to this mail.</b>";
$mail->Mailer = "smtp"; 
...
$mail->Subject    = "smarTAlloc : Select Your TAs";
