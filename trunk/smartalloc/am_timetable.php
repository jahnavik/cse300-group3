...
<div id="left_content">
  ...
  Time Table for this Semester:
	...
	<label for="file" style=" font-weight:normal;  font-weight:normal;  font: 17px/1.5em Verdana, Geneva, Arial, Helvetica, sans-serif; min-width: 1000px; " class="text-info"><br/>Upload the time table here:</label>
    ...
    <!--<input type ="submit"  name="submit" value="Upload" />-->
     ...
     <button class="btn" type="submit" name="submit1" formaction="read_ta.php" id="move1" title="Go to the time table list you just uploaded" ><i class="cus-user-go"></i>   Move to Form</button>
     </form>
     
<div class="alert alert-error" style=" font-weight:normal;  margin-top: 100px; line-height: 1; font: 16px/1.5em Verdana, Geneva, Arial, Helvetica, sans-serif; min-width: 90px;">
...
<div id="right_content">
    ...
    <p class="text-info" style="margin-left:10px; line-height: 1; font: 12px/1.5em Verdana, Geneva, Arial, Helvetica, sans-serif; min-width: 90px;">  <br/>- Only xls file should be uploaded here fortime table list. </p>
</div>
</div>
