...
<div id="left_content">
  ...
  Time Table for this Semester:
    ...
    <!--<input type ="submit"  name="submit" value="Upload" />-->
     ...
     <button class="btn" type="submit" name="submit1" formaction="#"  onclick="myFunction()1" id="move1" title="Go to the time table list you just uploaded" ><i class="cus-table-go"></i>   Move to List</button>
     </form>
...
<div id="right_content">
    ...
    <p class="text-info" style="margin-left:10px; line-height: 1; font: 12px/1.5em Verdana, Geneva, Arial, Helvetica, sans-serif; min-width: 90px;">  <br/> 	- Upload only .xls files for Time Table for the current semester.</br> </br>
			- To view and modify the uploaded list, click on <b>'Move to List'</b></p>
</div>
